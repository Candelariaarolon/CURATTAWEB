...
export default function VerifyEmail({ verifyUrl }: { verifyUrl: string }) {
  return (
    <Html>
      <Head />
      <Preview>Confirmá tu cuenta de Curatta</Preview>
      <Body style={{ backgroundColor: "#f2e9da", fontFamily: "Georgia, serif" }}>
        ...
        >
          ...
          <Text style={{ fontSize: "15px", lineHeight: "1.6", color: "#17130f" }}>
            Gracias por crear tu cuenta en Curatta. Tocá el botón de abajo para
            confirmar tu email y activarla — el link vence en 24 horas.
          </Text>
          <Button
            href={verifyUrl}
            style={{
